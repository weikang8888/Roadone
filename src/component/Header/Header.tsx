...
const Header = () => {
  ...
  // Function to update state when the window size changes
  const handleResize = () => {
    // Remove "d-block" class when window width is more than 970px
  ...
  const toggleMenu = () => {
    // Toggle "d-block" class only if the window width is less than or equal to 970px
    if (window.innerWidth <= 970) {
      ...
      <nav className="navbar">
        <div className="container1 clearfix top">
          <div className="row align-items-center justify-content-between">
            ...
            <div>
              <ul className={`menu ${isMenuOpen ? "d-block" : ""}`}>
                <li>
