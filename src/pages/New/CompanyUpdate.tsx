...
const CompanyUpdate = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/news/news.php?ids=4,5,6")
      .then((response) => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>
          {t("header.company-update")} - {t("homepage.title")}
        </title>
      </Helmet>
      ...
      <section>
        <div className="container">
          ...
          <SubMenu
            previouspage="News"
            previouslink="/news"
            currentpage={"Company Update"}
            currentlink={"/news/companyupadte"}
          />
          <div className="main">
