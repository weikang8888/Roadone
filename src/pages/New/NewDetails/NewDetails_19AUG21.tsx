        ...
        <div className="container container1">
          ...
          <div className="main">
            <div className="newcon clearfix">
              <div className="tit">385/65R22.5 New Pattern HF281</div>
              <div className="time">- Aug 19, 2021-</div>
              <div className="pinfo">
                <p>
                ...
                <p>
                  <span className="">
                    <strong>
                      <span className="font-size-26">
                        385/65R22.5&nbsp; Designed for standard loading, long
                        distance, high speed in high-way, national roads,
                        suitable for steer and trailer positions.
                      </span>
                    </strong>
                  </span>
                </p>
                ...
                <p>
                  ...
                  performance and better stone ejection effect in different road
                  conditions.
                </p>
                <p>
                ...
                <p>
                  ...
                  heating recipe, optimized shoulder design, inhibiting deformed
