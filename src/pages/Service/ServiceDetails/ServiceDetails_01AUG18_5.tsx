...
const ServiceDetails_01AUG18_5 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/services/services.php?ids=8")
      .then((response) => {
            ...
            <div className="newcon clearfix">
              {newsItem && (
                <>
                  ...
                  <DetailsButton />
                  <DetailsPreviousNext
                    prevText={t("service.title.6")}
                    prevLink="/services/check-the-vehicle-problems-before-the-long-journey"
                    nextLink="/services/what-should-you-consider-when-choosing-a-new-tyre"
                    nextText={t("service.title.8")}
                  />
...
export default ServiceDetails_01AUG18_5;
