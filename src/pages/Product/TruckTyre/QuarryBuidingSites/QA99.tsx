...
const QA99 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?id=24")
      .then((response) => {
            ...
            <div className="tabs1 fr">
              <div className="cd_rt">
                <div className="cp_fl cp_fl2">
                  <ProductTypeBox
                    activeLink="quarry-building-site"
                    showTruckList={true}
                    showBusList={false}
                  />
                      ...
                      <div className="ct_xq_d2">
                        <div
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            High saturation, low void, stone ejection at the
                            bottom groove, large block design, enhancing the
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            ...
                            structure, specific heavy loading technology for
                            bead enhancing the anti-riot, anti-puncture,
                            pressure and load-resistance properties of non-paved
                            roads such as industrial and mining.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
