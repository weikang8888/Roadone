...
const QA19 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?id=22")
      .then((response) => {
                      ...
                      <div className="ct_xq_d2">
                        <div
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            Optimized cap and shoulder contour design, excellent
                            performance on mixed road conditions.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            Four zigzag grooves and solid logitudinal ribs
                            design, special sipes on tread, improving wet grip
                            perfomance, safe, comfortable and fuel-efficient.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            High-tensile casing steel cord structure design,
                            superior durability, retreadability.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <br />
                          </p>
