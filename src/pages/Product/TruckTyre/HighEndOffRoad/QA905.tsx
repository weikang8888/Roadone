...
const QA905 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?id=19")
      .then((response) => {
                      ...
                      <div className="ct_xq_d2">
                        <div
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            ...
                            grounding area and performance in the soft
                          ...
                          <table>
                            <tbody>
                              ...
                              <tr>
                                <td width="93">11.00R20</td>
                                <td
                                  width="67"
                                  style={{ wordBreak: "break-all" }}>
                                  18PR★★
                                </td>
                                <td width="136">3550/3250</td>
                                <td width="129">152/149</td>
                                <td width="79">D</td>
                                <td width="93">1103</td>
                                <td width="92">293</td>
                                <td width="92">930</td>
                              ...
                              <tr>
                                ...
                                <td width="136">4000/3650</td>
                                <td width="129">156/153</td>
                                <td width="79">D</td>
                                <td width="93">1134</td>
                                <td width="92">315</td>
                                <td width="92">900</td>
