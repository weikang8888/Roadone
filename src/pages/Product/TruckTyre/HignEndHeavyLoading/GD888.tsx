...
const GD888 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/api_roadone/products/products?id=17")
      .then((response) => {
  ...
  return (
    <>
      ...
      <div className="container">
                          ...
                          <div className="ct_xq_lt fl">
                            ...
                            <div className="ct_xqq">
                              <div
                                ...
                                <div>
                                  {t("products.products_description.17")}
                                </div>
                              </div>
                              <div
                                className="ct_xq3"
                      ...
                      <div className="ct_xq_d2">
                        <div
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            {t("truck.highEndHeavyLoading.GD888.content1")}
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            {t("truck.highEndHeavyLoading.GD888.content2")}
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            {t("truck.highEndHeavyLoading.GD888.content3")}
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            {t("truck.highEndHeavyLoading.GD888.content4")}
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            {t("truck.highEndHeavyLoading.GD888.content5")}
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <br />
                          </p>
        ...
        <SwipperProduct ids={[53, 28, 46, 13, 21, 52, 20, 40, 35]} />
      </div>
    </>
  );
};
