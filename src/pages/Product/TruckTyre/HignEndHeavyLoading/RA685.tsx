...
const RA685 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?id=11")
      .then((response) => {
                ...
                <div className="ct_xq_d2">
                  <div
                    ...
                    <p style={{ whiteSpace: "normal" }}>
                      ...
                      tubeless III+ generation heavy load tech,improves the
                      fatigue and shear resistance of tyre bead under ultra-high
                      and heavy load conditions,reduce quality risks of the bead
                    ...
                    <table>
                      <tbody>
                        ...
                        <tr>
                          <td width="93" style={{ wordBreak: "break-all" }}>
                            13R22.5
                          </td>
                          <td width="51" style={{ wordBreak: "break-all" }}>
                            20PR★
                          </td>
                          <td width="85">4000/3650</td>
                          <td width="104">156/153</td>
                          <td width="63">K</td>
                          <td width="68">1121</td>
                          <td width="65">320</td>
                          <td width="57">930</td>
