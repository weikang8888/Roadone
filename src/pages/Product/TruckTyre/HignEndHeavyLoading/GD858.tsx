...
const GD858 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?id=15")
      .then((response) => {
  ...
  return (
    <>
      ...
      <div className="container">
                      ...
                      <div className="ct_xq_d2">
                        <div
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            Unique horizontal and vertical blocks, puncture
                            resistance bottom design and stone ejection design
                            provide strong drive and braking performance.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
        ...
        <SwipperProduct ids={[53, 28, 14, 46, 52, 21, 23, 34, 35]} />
      </div>
    </>
  );
};
