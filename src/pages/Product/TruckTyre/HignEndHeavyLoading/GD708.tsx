...
const GD708 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?id=13")
      .then((response) => {
                      ...
                      <div className="ct_xq_d2">
                        <div
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            Strong driving, heat-dissipating type, shoulder
                            rip-proof reinforced connecting ribs, groove bottom
                            stone ejection, puncture resistance block design,
                            providing strong driving performance, effectively
                            preventing cracks, lumps, and inhibiting deformed
                            wear.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            High wear-resistant tread formula design and widened
                            tread pattern design ensure longer service life of
                            the product.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            ...
                            adopts III+ generation heavy load tech,improves the
                            fatigue and shear resistance of tyre bead under
                            ultra-high and heavy load conditions,reduce quality
                            risks of the bead seperation, crack or explosion.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <br />
                          </p>
