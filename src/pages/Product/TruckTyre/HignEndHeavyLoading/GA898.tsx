...
const GA898 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?id=14")
      .then((response) => {
                      ...
                      <div className="ct_xq_d2">
                        <div
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            The unique horizontal and vertical patterns and the
                            horizontally longitudinally connecting ribs,
                            puncture resistance and stone ejection design
                            effectively prevent the cracks, lumps and
                            deformations from being deformed.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
