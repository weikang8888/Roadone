...
const HF262 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?id=3")
      .then((response) => {
  ...
  return (
    <>
      ...
      <div className="container">
                      ...
                      <div className="ct_xq_d2">
                        <div
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            Optimized profile design, with angle traction
                            pattern groove wall design, providing good traction
                            performance and excellent anti eccentric wear
                            performance in different wheel positions and
                            different road conditions.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            High-way special super wear-resistant tread formula
                            design, widened driving surface, deepened and high
                            saturation pattern design ensure a higher mileage in
                            high-way, National Road and other mixed road
                            conditions.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            ...
                            seperation, crack or explosion,ensure multiple
                            retreading of tires.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <br />
        ...
        <SwipperProduct ids={[46, 21, 52, 61, 34, 40, 48, 53, 28]} />
      </div>
    </>
  );
};

export default HF262;
