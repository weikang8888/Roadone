...
const RA325 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/api_roadone/products/products?id=6")
      .then((response) => {
  ...
  return (
    <>
      ...
      <div className="container">
                          ...
                          <div className="ct_xq_lt fl">
                            ...
                            <div className="ct_xqq">
                              <div
                                ...
                                <div>
                                  {t("products.products_description.6")}
                                </div>
                              </div>
                              <div
                                className="ct_xq3"
                      ...
                      <div className="ct_xq_d2">
                        <div
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            {t("truck.highEndWearable.RA325.content1")}
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            {t("truck.highEndWearable.RA325.content2")}
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            {t("truck.highEndWearable.RA325.content3")}
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            {t("truck.highEndWearable.RA325.content4")}
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <br />
                          </p>
        ...
        <SwipperProduct ids={[53, 46, 28, 14, 61, 21, 48, 35, 42]} />
      </div>
    </>
  );
};
