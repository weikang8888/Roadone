...
const RA325 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?id=6")
      .then((response) => {
                      ...
                      <div className="ct_xq_d2">
                        <div
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            ...
                            steel sheet design, excellent grip performance and
                            driving and braking performance in different
                            positions in high-way driving conditions.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            Deepened tread depth, special super wear-resistant
                            tread formula for high-way drive, ensure higher
                            mileage in mixed road conditions such as high speed
                            and national road.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
