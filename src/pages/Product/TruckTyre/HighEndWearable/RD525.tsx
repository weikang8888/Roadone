...
const RD525 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?id=9")
      .then((response) => {
                      ...
                      <div className="ct_xq_d2">
                        <div
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            Unique ribbed design with direction, asymmetric
                            lateral groove angle, optimized steel sheet design,
                            providing strong driving performance, effectively
                            suppressing deformed wear.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            High-way specific wearable tread design, widening
                            tread surface to ensure higher mileage in mixed road
                          ...
                          <table>
                            <tbody>
                              ...
                              <tr>
                                <td width="135">12R22.5</td>
                                <td width="75">18PR</td>
                                <td width="117">3550/3250</td>
                                <td width="143">152/149</td>
                                <td width="87">L</td>
                                <td width="99">1092</td>
                                <td width="88">300</td>
                                <td width="91">930</td>
