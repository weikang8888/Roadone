                ...
                <div className="ct_xq_d2">
                  <div
                    ...
                    <p style={{ whiteSpace: "normal" }}>
                      <span>&gt;</span>
                      Unique ribbed design with direction, asymmetric lateral
                      groove angle, optimized steel sheet design, providing
                      strong driving performance, effectively suppressing
                      deformed wear.
                    </p>
                    <p style={{ whiteSpace: "normal" }}>
                      <span>&gt;</span>
                      High-way specific wearable tread design, widening tread
                      surface to ensure higher mileage in mixed road conditions
                    ...
                    <table>
                      <tbody>
                        ...
                        <tr>
                          <td width="135" style={{ wordBreak: "break-all" }}>
                            315/80R22.5
                          </td>
                          <td width="75">20PR</td>
                          <td>4125/3750</td>
