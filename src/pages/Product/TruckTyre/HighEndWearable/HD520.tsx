...
const HD520 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?id=7")
      .then((response) => {
                ...
                <div className="ct_xq_d2">
                  <div
                    ...
                    <p style={{ whiteSpace: "normal" }}>
                      <span>&gt;</span>
                      With unique pattern and optimized steel plate design, it
                      can provide strong driving performance and traction
                      performance, and effectively restrain irregular wear.
                    </p>
                    <p style={{ whiteSpace: "normal" }}>
                      <span>&gt;</span>
