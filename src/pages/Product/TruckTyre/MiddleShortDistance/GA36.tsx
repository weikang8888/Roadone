...
const GA36 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/api_roadone/products/products?id=29")
      .then((response) => {
                          ...
                          <div className="ct_xq_lt fl">
                            ...
                            <div className="ct_xqq">
                              <div
                                ...
                                <div>
                                  {t("products.products_description.29")}
                                </div>
                              </div>
                              <div
                                className="ct_xq3"
                      ...
                      <div className="ct_xq_d2">
                        <div
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            {t("truck.middleShortDistance.GA36.content1")}
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            {t("truck.middleShortDistance.GA36.content2")}
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            {t("truck.middleShortDistance.GA36.content3")}
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <br />
                          </p>
