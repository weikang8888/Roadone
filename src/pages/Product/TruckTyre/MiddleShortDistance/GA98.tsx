...
const GA98 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?id=28")
      .then((response) => {
                      ...
                      <div className="ct_xq_d2">
                        <div
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            Optimized horizontal and vertical patterns and the
                            strong bottom groove strengthen the connecting ribs
                            in the longitudinal direction, and puncture
                            resistance and stone-ejection grooves are designed
                            and treated to effectively prevent the cracks, the
                            lumps, and the deformation of the deformed wear.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
