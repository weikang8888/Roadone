...
const RF12 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?id=48")
      .then((response) => {
                ...
                <div className="ct_xq_d2">
                  <div
                    ...
                    <p style={{ whiteSpace: "normal" }}>
                      ...
                      higher mileage in high-speed, National Road and other
                    ...
                    <table>
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="72">12PR</td>
                          <td width="143">2725/2575</td>
                          <td width="121">143/141</td>
                          <td width="72">M</td>
                          <td width="88">1085</td>
                          <td width="92">300</td>
                          <td width="72">620</td>
