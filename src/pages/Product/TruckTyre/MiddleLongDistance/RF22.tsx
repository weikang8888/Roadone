...
const RF22 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?id=33")
      .then((response) => {
                    ...
                    <div className="ct_xq">
                      ...
                      <div className="ct_xq_d2">
                        <div
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            High-speed specific wearable tread design, ensure
                            higher mileage.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            Reinforced cap specific 4 belt cap design, low
                            heating recipe, optimised shoulder desigh,
                            inhibiting reduce the rolling resistance of
                            driving,environmental protection,suitable for
