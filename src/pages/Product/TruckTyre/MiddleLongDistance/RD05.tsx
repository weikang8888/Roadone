...
const RD05 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?id=42")
      .then((response) => {
                ...
                <div className="ct_xq_d2">
                  <div
                    ...
                    <p style={{ whiteSpace: "normal" }}>
                      <span>&gt;</span>
                      Four zigzag grooves and solid logitudinal ribs design,
                      special sipes on tread, improving driving and wet grip
                      perfomance, safe, comfortable and fuel-efficient.
                    </p>
                    <p style={{ whiteSpace: "normal" }}>
                      <span>&gt;</span>
                    ...
                    <table>
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>152/149</td>
                          <td>L</td>
                          <td style={{ wordBreak: "break-all" }}>1097</td>
                          <td>300</td>
                          <td>930</td>
                          <td>9.00</td>
                        </tr>
