...
const RD65 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?id=34")
      .then((response) => {
                      ...
                      <div className="ct_xq_d2">
                        <div
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            ...
                            transverse grooves to provide super driving force
                            and wet grip, safe, comfortable and fuel saving.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            Optimized profile design, special super
                            wear-resistant tread formula for high-speed drive,
                            ensure higher mileage in mixed road conditions such
                            as high-way and national road.
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
