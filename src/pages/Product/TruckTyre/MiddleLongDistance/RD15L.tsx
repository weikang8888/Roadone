...
const RD15L = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?id=38")
      .then((response) => {
                ...
                <div className="ct_xq_d2">
                  <div
                    ...
                    <p style={{ whiteSpace: "normal" }}>
                      <span>&gt;</span>
                      Dedicated block design for powerful driving and slippery
                      grip.
                    </p>
                    <p style={{ whiteSpace: "normal" }}>
                      <span>&gt;</span>
                    ...
                    <p style={{ whiteSpace: "normal" }}>
                      <span>&gt;</span>
                      Reinforced high cap strength structure, low heating
                      recipe, optimised shoulder desigh, inhibiting deformed
                      wear and shoulder explosion.
                    </p>
                    <p style={{ whiteSpace: "normal" }}>
                      <span>&gt;</span>
