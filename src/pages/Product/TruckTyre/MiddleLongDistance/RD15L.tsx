...
const RD15L = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/api_roadone/products/products?id=38")
      .then((response) => {
                          ...
                          <div className="ct_xq_lt fl">
                            ...
                            <div className="ct_xqq">
                              <div
                                ...
                                <div>
                                  {t("products.products_description.38")}
                                </div>
                              </div>
                              <div
                                className="ct_xq3"
                      ...
                      <div className="ct_xq_d2">
                        <div
                          ...
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            {t("truck.middleLongDistance.RD15L.content1")}
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            {t("truck.middleLongDistance.RD15L.content2")}
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            {t("truck.middleLongDistance.RD15L.content3")}
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <span>&gt;</span>
                            {t("truck.middleLongDistance.RD15L.content4")}
                          </p>
                          <p style={{ whiteSpace: "normal" }}>
                            <br />
                          </p>
