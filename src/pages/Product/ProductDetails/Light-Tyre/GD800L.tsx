...
const GD800L = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=71")
      .then((response) => {
        ...
        <div className="container container1">
          ...
          <div className="main">
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.71")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.71")}</p>
                    </div>
            ...
            <div className="pinfo">
              ...
              <DetailsPreviousNext
                prevText={"GA06"}
                prevLink="/products/light-truck-tire/ga06-light"
                nextText={"QA39"}
                nextLink="/products/light-truck-tire/qa39"
              />
              <p className="productsTags">
                Hot Tags: gd800, China, suppliers, manufacturers, factory,
                wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="73,69,76,72,77,74" />
            </div>
          </div>
        </div>
      </section>
