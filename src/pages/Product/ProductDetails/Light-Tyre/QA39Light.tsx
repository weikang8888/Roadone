...
const QA39Light = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=78")
      .then((response) => {
            ...
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.78")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.78")}</p>
                    </div>
            ...
            <div className="pinfo">
              ...
              <p>
                <span className="table-text">
                  ...
                  {t(
                    "product.productDetaildescriptions.productDetaildescriptions65"
                  )}
                </span>
              </p>
              <p>
                <span className="table-text">
                  ...
                  {t(
                    "product.productDetaildescriptions.productDetaildescriptions66"
                  )}
                </span>
              </p>{" "}
              <p>
                <span className="table-text">
                  ...
                  {t(
                    "product.productDetaildescriptions.productDetaildescriptions67"
                  )}
                </span>
              </p>
              <p>
                <span className="table-text">
                  ...
                  {t(
                    "product.productDetaildescriptions.productDetaildescriptions68"
                  )}
                </span>
              </p>
              <p>
                <span className="table-text">
                  ...
                  {t(
                    "product.productDetaildescriptions.productDetaildescriptions69"
                  )}
                </span>
              </p>
              ...
              <DetailsPreviousNext
                prevText={"GD08 Light Truck Tyre"}
                prevLink="/products/light-truck-tire/gd08-light"
                nextText={"QA999 Light Truck Tyre"}
                nextLink="/products/light-truck-tire/qa999-light"
              />
              <p className="productsTags">
                Hot Tags: qa39 light truck tire, China, suppliers,
                manufacturers, factory, wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="28,9,21,23,2,33" />
            </div>
          </div>
        </div>
      </section>
