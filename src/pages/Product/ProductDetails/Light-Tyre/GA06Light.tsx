...
const GA06Light = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=70")
      .then((response) => {
            ...
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.70")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.70")}</p>
                    </div>
            ...
            <div className="pinfo">
              ...
              <p>
                <span className="table-text">
                  ...
                  {t(
                    "product.productDetaildescriptions.productDetaildescriptions63"
                  )}
                </span>
              </p>
              <p>
                <span className="table-text">
                  ...
                  {t(
                    "product.productDetaildescriptions.productDetaildescriptions64"
                  )}
                </span>
              </p>
              ...
              <DetailsPreviousNext
                prevText={"RA85 Light Truck Tyre"}
                prevLink="/products/light-truck-tire/ra85-light"
                nextText={"GD800"}
                nextLink="/products/light-truck-tire/gd800"
              />
              <p className="productsTags">
                Hot Tags: ga06, China, suppliers, manufacturers, factory,
                wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="72,74,77,76,75,69" />
            </div>
          </div>
        </div>
      </section>
