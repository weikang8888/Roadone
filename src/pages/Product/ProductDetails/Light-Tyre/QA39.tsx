...
const QA39 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=72")
      .then((response) => {
        ...
        <div className="container container1">
          ...
          <div className="main">
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.72")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.72")}</p>
                    </div>
            ...
            <div className="pinfo">
              ...
              <DetailsPreviousNext
                prevText={"GD800"}
                prevLink="/products/light-truck-tire/gd800"
                nextText={"QA999"}
                nextLink="/products/light-truck-tire/qa999"
              />
              <p className="productsTags">
                Hot Tags: qa39, China, suppliers, manufacturers, factory,
                wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="71,15,5,42,31,14" />
            </div>
          </div>
        </div>
      </section>
