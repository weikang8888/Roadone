...
const GD800Light = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?ids=76")
      .then((response) => {
          ...
          <div className="main">
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.76")}</h1>
            ...
            <div className="pinfo">
              ...
              <p className="productsTags">
                Hot Tags: gd800 light truck tire, China, suppliers,
                manufacturers, factory, wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="78,67,79,9,19,40" />
            </div>
          </div>
        </div>
      </section>
