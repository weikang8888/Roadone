...
const A12_00R24TruckTire = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?ids=98")
      .then((response) => {
          ...
          <div className="main">
            ...
            <div className="pinfo">
              ...
              <p className="productsTags">
                Hot Tags: 12.00r24 truck tire, China, suppliers, manufacturers,
                factory, wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="92,93,94,95,96,97" />
            </div>
          </div>
        </div>
      </section>
...
export default A12_00R24TruckTire;
