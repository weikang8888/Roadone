...
const RoadCommercialTire = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=96")
      .then((response) => {
        ...
        <div className="container container1">
          ...
          <div className="main">
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.96")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.96")}</p>
                    </div>
            ...
            <div className="pinfo">
              ...
              <DetailsPreviousNext
                prevText={t("product.title.95")}
                prevLink="/products/roadone-tyre-demonstration/bus-tire"
                nextText={t("product.title.97")}
