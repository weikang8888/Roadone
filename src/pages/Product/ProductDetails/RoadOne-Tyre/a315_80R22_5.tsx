...
const A315_80R22_5 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=92")
      .then((response) => {
            ...
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.92")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.92")}</p>
                    </div>
