...
const A315_80R22_5 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?ids=92")
      .then((response) => {
        ...
        <div className="container container1">
          ...
          <div className="main">
            ...
            <div className="pinfo">
              ...
              <DetailsPreviousNext
                prevText={"425/65R22.5 Tubeless Truck Tyre"}
                prevLink="/products/roadone-tyre-demonstration/425-65r22-5-tubeless"
                nextText={"Truck Tyre"}
                nextLink="/products/roadone-tyre-demonstration/truck-tire"
              />
              <p className="productsTags">
                Hot Tags: 315/80r22.5 truck tire, China, suppliers,
                manufacturers, factory, wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="93,94,95,96,87,99" />
            </div>
          </div>
        </div>
      </section>
