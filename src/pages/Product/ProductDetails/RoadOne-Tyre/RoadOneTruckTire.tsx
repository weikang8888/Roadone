...
const RoadOneTruckTire = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?ids=93")
      .then((response) => {
          ...
          <div className="main">
            ...
            <div className="pinfo">
              ...
              <div className="my-3">
                ...
                <p>
                  <span>9.00R20 Truck Tyre</span>
                </p>{" "}
                <p>
                  <span>10.00R20 Truck Tyre</span>
                </p>{" "}
                <p>
                  <span>9R22.5 Truck Tyre</span>
                </p>{" "}
                <p>
                  <span>10R22.5 Truck Tyre</span>
                </p>{" "}
                <p>
                  <span>11.00R20 Truck Tyre</span>
                </p>{" "}
                <p>
                  <span>11R22.5 Truck Tyre</span>
                </p>{" "}
                <p>
                  <span>12.00R20 Truck Tyre</span>
                </p>{" "}
                <p>
                  <span>12.00R24 Truck Tyre</span>
                </p>{" "}
                <p>
                  <span>12R22.5 Truck Tyre</span>
                </p>
                <p>
                  <span>13R22.5 Truck Tyre</span>
                </p>
                <p>
                  <span>215/75R17.5 Truck Tyre</span>
                </p>
                <p>
                  <span>235/75R17.5 Truck Tyre</span>
                </p>
                <p>
                  <span>245/70R19.5 Truck Tyre</span>
                </p>
                <p>
                  <span>265/70R19.5 Truck Tyre</span>
                </p>
                <p>
                  <span>275/70R22.5 Truck Tyre</span>
                </p>{" "}
                <p>
                  <span>295/60R22.5 Truck Tyre</span>
                </p>{" "}
                <p>
                  <span>295/80R22.5Truck Tyre</span>
                </p>{" "}
                <p>
                  <span>315/60R22.5 Truck Tyre</span>
                </p>{" "}
                <p>
                  <span>315/70R22.5 Truck Tyre</span>
                </p>{" "}
                <p>
                  <span>315/80R22.5 Truck Tyre</span>
                </p>{" "}
                <p>
                  <span>385/65R22.5 Truck Tyre</span>
                </p>{" "}
                <p>
                  <span>425/65R22.5 Truck Tyre</span>
                </p>
                <p>
                  <span>14.00R20 Truck Tyre</span>
                </p>
              </div>
              <DetailsPreviousNext
                prevText={"315/80R22.5 Truck Tyre"}
                prevLink="/products/roadone-tyre-demonstration/315-80r22-5"
                nextText={"Light Truck Tyre"}
                nextLink="/products/roadone-tyre-demonstration/light-truck-tire"
              />
              <p className="productsTags">
                Hot Tags: truck tire, China, suppliers, manufacturers, factory,
                wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="4,28,61,23,6,48" />
            </div>
          </div>
        </div>
      </section>
...
export default RoadOneTruckTire;
