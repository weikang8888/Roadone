...
const RD05 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?ids=20")
      .then((response) => {
            ...
            <div className="pinfo">
              ...
              <p>
                <span className="table-text">
                  ...
                  Four zigzag grooves and solid logitudinal ribs design, special
                  sipes on tread, improving driving and wet grip perfomance,
                  safe, comfortable and fuel-efficient.
                </span>
              </p>
              <p>
                <span className="table-text">
                  ...
                  Widened driving surface, optimized profile design, special
                  super wear-resistant tread formula for high-speed drive,
                  ensure higher mileage in mixed road conditions such as
                  high-way and national road.
                </span>
              </p>
              <p>
                <span className="table-text">
              ...
              <table width="100%" className="table mt-3">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td width="88">
                      <span className="table-text">1097 </span>
                    </td>
                    <td width="95">
              ...
              <DetailsPreviousNext
                prevText={"RD35"}
                prevLink="/products/truck-tire/long-distance-standard-load-truck-tire/rd35"
                nextText={"RT02"}
                nextLink="/products/truck-tire/long-distance-standard-load-truck-tire/rt02"
              />
              <p className="productsTags">
                Hot Tags: RD05, China, suppliers, manufacturers, factory,
                wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="43,11" />
            </div>
          </div>
        </div>
      </section>
