...
const RD65 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?ids=18")
      .then((response) => {
            ...
            <div className="pinfo">
              ...
              <p>
                <span className="table-text">
                  ...
                  Four longitudinal grooves are designed with inclined
                  transverse grooves to provide super driving force and wet
                  grip, safe, comfortable and fuel saving.
                </span>
              </p>
              <p>
                <span className="table-text">
                  ...
                  Optimized profile design, special super wear-resistant tread
                  formula for high-speed drive, ensure higher mileage in mixed
                  road conditions such as high-way and national road.
                </span>
              </p>
              <p>
                <span className="table-text">
              ...
              <DetailsPreviousNext
                prevText={"RA25"}
                prevLink="/products/truck-tire/long-distance-standard-load-truck-tire/ra25"
                nextText={"RD35"}
                nextLink="/products/truck-tire/long-distance-standard-load-truck-tire/rd35"
              />
              <p className="productsTags">Hot Tags: RD65</p>
              <DetailsRelatedProducts ids="16,68,33" />
            </div>
          </div>
        </div>
      </section>
