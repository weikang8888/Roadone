...
const RD525 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=63")
      .then((response) => {
            ...
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.63")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.63")}</p>
                    </div>
  ...
  {t(
            ...
            {t(
              ...
              <DetailsPreviousNext
                prevText={"HD520"}
                prevLink="/products/truck-tire/high-end-wearable-tyre/hd520"
                nextText={"RA325"}
                nextLink="/products/truck-tire/high-end-wearable-tyre/ra325"
              />
              <p className="productsTags">
                Hot Tags: RD525, China, suppliers, manufacturers, factory,
                wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="47,32,79,67,46,1" />
            </div>
          </div>
        </div>
      </section>
