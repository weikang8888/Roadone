...
const HF262 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=61")
      .then((response) => {
  ...
  return (
            ...
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.61")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.61")}</p>
                    </div>
   <a href="/contact" rel="nofollow" className="p_more mmv">
            ...
            <div className="pinfo">
              ...
              <table width="100%" className="table mt-3">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td width="88">
                      <span className="table-text">1087 </span>
                    </td>
                    <td width="95">
              ...
              <DetailsPreviousNext
                prevText={"HF252"}
                prevLink="/products/truck-tire/high-end-wearable-tyre/hf252"
                nextText={"HD520"}
                nextLink="/products/truck-tire/high-end-wearable-tyre/hd520"
              />
              <p className="productsTags">
                Hot Tags: HF262, China, suppliers, manufacturers, factory,
                wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="47,57,51,43,65,7" />
            </div>
          </div>
        </div>
      </section>
