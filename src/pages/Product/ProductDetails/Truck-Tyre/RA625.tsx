...
const RA625 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=54")
      .then((response) => {
  ...
  return (
            ...
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.54")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.54")}</p>
                    </div>
   <a href="/contact" rel="nofollow" className="p_more mmv">
            ...
            <div className="pinfo">
              ...
              <DetailsPreviousNext
                prevText={"GD800"}
                prevLink="/products/truck-tire/high-end-heavy-loading-tyres/gd800"
                nextText={"RA685"}
                nextLink="/products/truck-tire/high-end-heavy-loading-tyres/ra685"
              />
              <p className="productsTags">
                Hot Tags: RA625, China, suppliers, manufacturers, factory,
                wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="51,20,18,1,40,50" />
            </div>
          </div>
        </div>
      </section>
