...
const RA95 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=9")
      .then((response) => {
 ...
 typepage={t("submenu.mid-long-distance-wearable")}          />
          <div className="main">
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.9")}</h1>
            ...
            <div className="pinfo">
              ...
              <DetailsPreviousNext
                prevText={"RF02"}
                prevLink="/products/truck-tire/long-distance-standard-load-truck-tire/rf02"
                nextText={"RD25"}
                nextLink="/products/truck-tire/long-distance-standard-load-truck-tire/rd25"
              />
              <p className="productsTags">
                Hot Tags: RA95, China, suppliers, manufacturers, factory,
                wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="34,67" />
            </div>
          </div>
        </div>
      </section>
