...
const RF61 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=12")
      .then((response) => {
 ...
 typepage={t("submenu.mid-long-distance-wearable")}          />
            ...
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.12")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.12")}</p>
                    </div>
   <a href="/contact" rel="nofollow" className="p_more mmv">
            ...
            <div className="pinfo">
              ...
              <DetailsPreviousNext
                prevText={"RA36"}
                prevLink="/products/truck-tire/long-distance-standard-load-truck-tire/ra36"
                nextText={"RF22"}
                nextLink="/products/truck-tire/long-distance-standard-load-truck-tire/rf22"
              />
              <p className="productsTags">
                Hot Tags: rf61, China, suppliers, manufacturers, factory,
                wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="16,9,17,13,21,20" />
            </div>
          </div>
        </div>
      </section>
