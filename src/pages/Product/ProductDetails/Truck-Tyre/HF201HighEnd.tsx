...
const HF201HighEnd = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=26")
      .then((response) => {
            ...
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.26")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.26")}</p>
                    </div>
   <a href="/contact" rel="nofollow" className="p_more mmv">
            ...
            <div className="pinfo">
              ...
              <p className="productsTags">
                Hot Tags: RF202 High End Wearable Highway Tyre, Long distance on
                highway tire
              </p>
