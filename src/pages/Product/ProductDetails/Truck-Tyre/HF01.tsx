...
const HF01 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=43")
      .then((response) => {
            ...
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.43")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.43")}</p>
                    </div>
   <a href="/contact" rel="nofollow" className="p_more mmv">
            ...
            <div className="pinfo">
              ...
              <p className="productsTags">
                Hot Tags: HF01 Long Distance Wearable Tyre
              </p>
