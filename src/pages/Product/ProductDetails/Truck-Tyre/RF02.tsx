...
const RF02 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=8")
      .then((response) => {
            ...
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.8")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.8")}</p>
                    </div>
   <a href="/contact" rel="nofollow" className="p_more mmv">
            ...
            <div className="pinfo">
              ...
              <DetailsPreviousNext
                ...
                nextText={"RA95"}
                nextLink="/products/truck-tire/long-distance-standard-load-truck-tire/ra95"
              />
              <p className="productsTags">
                Hot Tags: rf02, China, suppliers, manufacturers, factory,
                wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="21,25,19,16,17,14" />
            </div>
          </div>
        </div>
      </section>
