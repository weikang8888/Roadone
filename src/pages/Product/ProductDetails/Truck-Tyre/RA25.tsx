...
const RA25 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=17")
      .then((response) => {
 ...
 typepage={t("submenu.mid-long-distance-wearable")}          />
   ...
   <a href="/contact" rel="nofollow" className="p_more mmv">
            ...
            <div className="pinfo">
              ...
              <DetailsPreviousNext
                prevText={"RF12"}
                prevLink="/products/truck-tire/long-distance-standard-load-truck-tire/rf12"
                nextText={"RD65"}
                nextLink="/products/truck-tire/long-distance-standard-load-truck-tire/rd65"
              />
              <p className="productsTags">
                Hot Tags: Middle End Mid-long Distance Wearable Tyre, China,
                suppliers, manufacturers, factory, wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="23,24,15" />
            </div>
          </div>
        </div>
      </section>
