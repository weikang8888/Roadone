...
const RA36 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=11")
      .then((response) => {
            ...
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.11")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.11")}</p>
                    </div>
            ...
            <div className="pinfo">
              ...
              <p>
                <span className="table-text">
                  ...
                  {t(
                    "product.productDetaildescriptions.productDetaildescriptions19"
                  )}
                </span>
              </p>
              <p>
                <span className="table-text">
                  ...
                  {t(
                    "product.productDetaildescriptions.productDetaildescriptions20"
                  )}
                </span>
              </p>
              <p>
              ...
              <table width="100%" className="table mt-3">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td width="88">
                      <span className="table-text">1076 </span>
                    </td>
                    <td width="95">
                      <span className="table-text">389</span>
                    </td>
                    <td width="72">
                  ...
                  <tr>
                    ...
                    <td width="131">
                      <span className="table-text">164 </span>
                    </td>
                    <td width="72">
                      <span className="table-text">K </span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td width="88">
                      <span className="table-text">1124 </span>
                    </td>
                    <td width="95">
                      <span className="table-text">422</span>
                    </td>
                    <td width="72">
                      <span className="table-text">830</span>
                    </td>
                    <td width="111">
                      <span className="table-text">12.25</span>
                    </td>
                  </tr>
                </tbody>
              </table>
              <DetailsPreviousNext
                prevText={"RD25"}
                prevLink="/products/truck-tire/long-distance-standard-load-truck-tire/rd25"
                nextText={"RF61"}
                nextLink="/products/truck-tire/long-distance-standard-load-truck-tire/rf61"
              />
              <p className="productsTags">Hot Tags: RA36</p>
              <DetailsRelatedProducts ids="2,28,17" />
            </div>
          </div>
        </div>
      </section>
