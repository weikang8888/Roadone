...
const RD25 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=10")
      .then((response) => {
            ...
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.10")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.10")}</p>
                    </div>
            ...
            <div className="pinfo">
              ...
              <p>
                <span className="table-text">
                  ...
                  {t(
                    "product.productDetaildescriptions.productDetaildescriptions16"
                  )}
                </span>
              </p>
              <p>
