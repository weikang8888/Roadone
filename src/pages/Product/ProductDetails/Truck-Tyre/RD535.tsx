...
const RD535 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?ids=59")
      .then((response) => {
            ...
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.59")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.59")}</p>
                    </div>
  ...
  {t(
            ...
            {t(
              ...
              <DetailsPreviousNext
                ...
                nextText={"HF252"}
                nextLink="/products/truck-tire/high-end-wearable-tyre/hf252"
              />
              <p className="productsTags">
                Hot Tags: rd535, China, suppliers, manufacturers, factory,
                wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="60,61,62,63,65,43" />
            </div>
          </div>
        </div>
      </section>
