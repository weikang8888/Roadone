...
const GD09MidShort = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=40")
      .then((response) => {
          ...
          <div className="main">
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.40")}</h1>
            ...
            <div className="pinfo">
              ...
              <p className="productsTags">
                Hot Tags: Mid-short Distance Heavy-duty Truck Tyre, China,
