...
const QA09 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=6")
      .then((response) => {
  ...
  return (
   ...
   <a href="/contact" rel="nofollow" className="p_more mmv">
            ...
            <div className="pinfo">
              ...
              <table width="100%" className="table mt-3">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td width="88">
                      <span className="table-text">1099</span>
                    </td>
                    <td width="95">
              ...
              <DetailsPreviousNext
                prevText={"QA99"}
                prevLink="/products/truck-tire/mine-truck-tire/qa99"
                nextText={"QA19"}
                nextLink="/products/truck-tire/mine-truck-tire/qa19"
              />
              <p className="productsTags">
                Hot Tags: mine and building tire, China, suppliers,
                manufacturers
              </p>
