  ...
  return (
            ...
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.58")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.58")}</p>
                    </div>
   <a href="/contact" rel="nofollow" className="p_more mmv">
            ...
            <div className="pinfo">
              ...
              <DetailsPreviousNext
                prevText={"GA898"}
                prevLink="/products/truck-tire/high-end-heavy-loading-tyres/ga898"
                nextText={"No Information"}
              />
              <p className="productsTags">
                Hot Tags: gd888 brand high end tyre,Pirelli, bridgestone tires ,
                Michelin, Firestone , Austone tyres
              </p>
              <DetailsRelatedProducts ids="52,53,51,54,55,50" />
            </div>
          </div>
        </div>
      </section>
