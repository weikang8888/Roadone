...
const GA898 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api_roadone/products/products?ids=57")
      .then((response) => {
          ...
          <div className="main">
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.57")}</h1>
            ...
            <div className="pinfo">
              ...
              <p className="productsTags">
                Hot Tags: GA898, China, suppliers, manufacturers, factory,
                wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="76,68,77,3,16,43" />
            </div>
          </div>
        </div>
      </section>
