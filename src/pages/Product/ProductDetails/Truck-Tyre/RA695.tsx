...
const RA695 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backend.roadone.com.my/products/products.php?ids=56")
      .then((response) => {
  ...
  return (
            ...
            <div className="row">
              {productItem && (
                <>
                  ...
                  <div className="col-7">
                    <h1 className="pd-title">{t("product.title.56")}</h1>
                    <div className="pcon_info">
                      <p>{t("product.description.56")}</p>
                    </div>
   <a href="/contact" rel="nofollow" className="p_more mmv">
            ...
            <div className="pinfo">
              ...
              <DetailsPreviousNext
                prevText={"RA685"}
                prevLink="/products/truck-tire/high-end-heavy-loading-tyres/ra685"
                nextText={"GA898"}
                nextLink="/products/truck-tire/high-end-heavy-loading-tyres/ga898"
              />
              <p className="productsTags">
                Hot Tags: RA695, China, suppliers, manufacturers, factory,
                wholesale, high-quality
              </p>
              <DetailsRelatedProducts ids="6,17,53,75,34,67" />
            </div>
          </div>
        </div>
      </section>
